...
def get_parser():
    ...
    parser.add_argument("-w", "--workers", default=16, type=int, help="Loader workers")
    parser.add_argument("--eval_workers", default=16, type=int, help="Final evaluation workers")
